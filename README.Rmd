...
The goal of `sfislands` is to make it easier to deal with geographic datasets which contain islands.
...
-   Secondly, just because two areas are separated by, say, a body of water, this does not mean that they are necessarily independent.
